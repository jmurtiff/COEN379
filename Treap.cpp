...
int main()
{
	...
	root = insert(root, 12,6);
	root = insert(root, 7,2);
	root = insert(root, 15,9);
	root = insert(root, 18,3);
	root = insert(root, 9,1);
	root = insert(root, 20,5);
	root = insert(root, 8,4);
	root = insert(root, 13,8);
